...
function AddSponsor() {
    ...
    // Updated tier options with durations and prices
    const tierOptions = [
        { value: 'Boost Package', label: 'Boost Package', duration: 3, durationLabel: '3 Months', price: 200 },
        { value: 'Growth Package', label: 'Growth Package', duration: 6, durationLabel: '6 Months', price: 800 },
        { value: 'Spotlight Package', label: 'Spotlight Package', duration: 12, durationLabel: '1 Year', price: 1500 }
    ];
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            formData.append('startDate', startDate);
            formData.append('endDate', endDate);
            formData.append('price', selectedTier.price); // Add price to form data
            console.log(formData);
    ...
    const handleSaveAsDraft = async () => {
        ...
        try {
            ...
            if (startDate) formData.append('startDate', startDate);
            if (endDate) formData.append('endDate', endDate);
            if (selectedTier) formData.append('price', selectedTier.price); // Add price to draft form data
            formData.append('isDraft', 'true'); // Add draft flag
                            ...
                            <div className="p-2">
                                {tierOptions.map((option) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-gray-900 font-medium">{option.label}</span>
                                            <span className="text-gray-500 text-sm">{option.durationLabel} - £{option.price}</span>
                                        </div>
                                    </label>
                                ))}
                            </div>
    ...
    return (
        <div className="mx-auto">
            ...
            <div className="flex flex-col space-y-4">
                ...
                {/* Display calculated duration, price, and end date (read-only) */}
                {selectedTierInfo && (
