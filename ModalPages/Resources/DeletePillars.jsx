    ...
    return (
        <div className="max-w-md mx-auto">
            ...
            <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                    <h2 className="text-xl font-semibold text-gray-900 mb-2">Delete Pillars</h2>
                    <p className="font-semibold text-black">Are you sure you want to delete this? </p>
                    <p className="text-gray-600 text-sm leading-relaxed">
                        This will remove all subcategories and content within it. This action cannot be undone.
                    </p>
                </div>
            </div>
