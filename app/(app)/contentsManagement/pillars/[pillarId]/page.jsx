...
//       showMessage( "error","Failed to load pillar details","error");
//     }
//   };
...
//       showMessage("error","Failed to load pillar content","error");
//     } finally {
//       setIsLoading(false);
//     }
//   };
            ...
            emptyState={
              <div className="flex flex-col text-center justify-center py-12 max-w-[350px] mx-auto">
                <Image
                  ...
                  alt="Frame"
                />
                <h4 className="text-xl font-rubikMedium my-2">No Resources Found</h4>
                <p className="text-md my-2">
