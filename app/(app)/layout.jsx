...
function Layout({ children }) {
  ...
  return (
    <Suspense>
      <div>
        <nav
          className="w-[250px] fixed left-0 top-0 bottom-0 font-rubikRegular"
          style={{ overflowY: "auto" }}
        >
          <div className="p-4 py-6 border border-bottom-1">
            <Image src={logo} className="w-2/3 m-auto" alt="Weave Logo" />
          </div>
          <div className="p-2 flex flex-col py-6 space-y-3">
            <Link
              href={"/dashboard"}
              className={
          ...
          <div className="mt-12 p-2 flex flex-col py-6">
            <Link
              href={"/settings"}
              className={
        ...
        <main className="bg-[#F5F6FA] fixed left-[250px] right-0 top-0 bottom-0">
          <nav className="fixed top-0 right-0 left-[250px] h-[60px] flex bg-white p-2 font-rubikRegular overflow-hidden">
            ...
            <div className="w-1/2 flex">
              <div className="w-1/2 flex space-x-8 justify-end px-16">
              ...
              {/* <div className="w-1/2 flex space-x-2">
                <img
                  src={
                    userInfo.headshot ? userInfo.headshot : placeholderAvatar
                  }
                  width={45}
                  alt="User Image"
                />
          ...
          <section className="absolute top-[60px] right-0 left-0 bottom-0 p-4 font-rubikRegular overflow-auto text-md">
            {children}
          </section>
        </main>
        <Modal />
